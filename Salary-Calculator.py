...
print(f'Hourly Rate: \t ${hourly_rate:>11,.2f}')
#Prints the calculation of gross pay
print(f'Gross Pay: \t ${gross_pay:>11,.2f}')
print()
print("Deductions:")
...
print(f'\tFederal Withholding {fed_tax:.1%}: \t ${fedtax_total:>11,.2f}')
#displays the state tax deduction
print(f'\tState Withholding {state_tax:.1%}: \t ${statetax_total:>11,.2f}')
#Calculates the total deduction 
total_deductions = fedtax_total + statetax_total
print(f'\tTotal Deductions: \t\t ${total_deductions:>11,.2f}')
#Calculates net pay
net_pay = gross_pay - total_deductions
#displays net pay 
print(f'\nNet pay: \t\t\t\t ${net_pay:>11,.2f}\n')
